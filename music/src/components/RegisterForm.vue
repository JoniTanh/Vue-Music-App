  ...
  <vee-form :validation-schema="schema" @submit="register" :initial-values="userData">
    ...
    <div class="mb-3">
      ...
      <vee-field
        ...
        class="block w-full py-1.5 px-3 text-gray-800 border border-gray-300 transition duration-500 focus:outline-none focus:border-black rounded"
      >
        <option value="Finland">{{ $t("register.finland") }}</option>
        <option value="Sweden">{{ $t("register.sweden") }}</option>
...
export default {
  ...
  data() {
    return {
      ...
      reg_alert_msg: this.$t('register.being_created')
    }
  },
  methods: {
    ...
    async register(values) {
      ...
      this.reg_alert_msg = this.$t('register.being_created')
